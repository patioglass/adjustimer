        ...
        <div className="min-h-screen font-sans">
            ...
            <section className="py-20 px-8 text-left lg:w-3/5 m-auto">
                <div className="p-6 rounded-sm">
                    <p>
                        ...
                        管理者が提供するサービスAdjusTimer（以下，「本サービス」といいます。）の利用条件を定めるものです。
            ...
            <section className="px-8 text-left lg:w-3/5 m-auto">
                <div className="p-6 rounded-sm">
                    ...
                    <p>管理者は本サービスに関し，本規約のほか，ご利用にあたってのルール等，各種の定め（以下，「個別規定」といいます。）をすることがあります。これら個別規定はその名称のいかんに関わらず，本規約の一部を構成するものとします。</p>
                    <p>本規約の規定が前条の個別規定の規定と矛盾する場合には，個別規定において特段の定めなき限り，個別規定の規定が優先されるものとします。</p>
                </div>
            </section>
            <section className="px-8 text-left lg:w-3/5 m-auto">
                <div className="p-6 rounded-sm">
                    <h3 className="text-xl font-semibold mb-2">第2条（禁止事項）</h3>
            ...
            <section className="px-8 text-left lg:w-3/5 m-auto">
                <div className="p-6 rounded-sm">
                    <h3 className="text-xl font-semibold mb-2">第3条（本サービスの提供の停止等）</h3>
                    <ol className="list-decimal list-inside">
                        <li>
            ...
            <section className="px-8 text-left lg:w-3/5 m-auto">
                <div className="p-6 rounded-sm">
                    <h3 className="text-xl font-semibold mb-2">第4条（著作権）</h3>
                    <ol className="list-decimal list-inside">
                        <li>
            ...
            <section className="px-8 text-left lg:w-3/5 m-auto">
                <div className="p-6 rounded-sm">
                    <h3 className="text-xl font-semibold mb-2">第5条（利用制限および登録抹消）</h3>
                   <ol className="list-decimal list-inside">
                        <li>
            ...
            <section className="px-8 text-left lg:w-3/5 m-auto">
                <div className="p-6 rounded-sm">
                    <h3 className="text-xl font-semibold mb-2">第6条（保証の否認および免責事項）</h3>
                   <ol className="list-decimal list-inside">
                        <li>
            ...
            <section className="px-8 text-left lg:w-3/5 m-auto">
                <div className="p-6 rounded-sm">
                    <h3 className="text-xl font-semibold mb-2">第7条（サービス内容の変更等）</h3>
                    <p>管理者は，ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。</p>
                </div>
            </section>
            <section className="px-8 text-left lg:w-3/5 m-auto">
                <div className="p-6 rounded-sm">
                    <h3 className="text-xl font-semibold mb-2">第8条（利用規約の変更）</h3>
                    <ol className="list-decimal list-inside">
                        <li>
            ...
            <section className="px-8 text-left lg:w-3/5 m-auto">
                <div className="p-6 rounded-sm">
                    <h3 className="text-xl font-semibold mb-2">第9条（個人情報の取扱い）</h3>
                    <p>管理者は，本サービスの利用によって取得する個人情報については，「<Link to="/privacy-policy" target="_blank">プライバシーポリシー</Link>」に従い適切に取り扱うものとします。</p>
                </div>
            </section>
            <section className="px-8 text-left lg:w-3/5 m-auto">
                <div className="p-6 rounded-sm">
                    <h3 className="text-xl font-semibold mb-2">第10条（権利義務の譲渡の禁止）</h3>
                    <p>ユーザーは，管理者の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。</p>
                </div>
            </section>
            <section className="px-8 text-left lg:w-3/5 m-auto">
                <div className="p-6 rounded-sm">
                    <h3 className="text-xl font-semibold mb-2">第11条（準拠法、裁判管轄）</h3>
                    <ol className="list-decimal list-inside">
                        <li>本利用規約の成立、効力発生、解釈にあたっては日本法を準拠法とします。また、当社のサービス（掲載内容や広告などを含む）、ソフトウエアに起因または関連して当社とお客様との間で生じた紛争については東京地方裁判所を第一審の専属的合意管轄裁判所とします。</li>
